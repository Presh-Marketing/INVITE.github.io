...
{\*\expandedcolortbl;;}
\margl1440\margr1440\vieww37900\viewh18380\viewkind0
...
\
        function getResultData(score) \{\
            ...
            if (numScore >= 0 && numScore <= 2.4) \{\
                return \{\
                    title: '\uc0\u55357 \u56628  Infrastructure Friction (Score: ' + score + '/5.0)',\
            ...
            \} else if (numScore >= 2.5 && numScore <= 3.4) \{\
                return \{\
                    title: '\uc0\u55357 \u57312  Progress with Gaps (Score: ' + score + '/5.0)',\
            ...
            \} else if (numScore >= 3.5 && numScore <= 4.2) \{\
                return \{\
                    title: '\uc0\u55357 \u57313  Built for Scale (Score: ' + score + '/5.0)',\
            ...
            \} else \{\
                return \{\
                    title: '\uc0\u55357 \u57314  AI-Ready Excellence (Score: ' + score + '/5.0)',\
...
\
            ...
            submitButton.innerHTML = `\
                <span style="display: inline-flex; align-items: center; gap: 0.5rem;">\
                    <span style="animation: spin 1s linear infinite; display: inline-block;">\uc0\u9203 </span>\
...
\
            setTimeout(() => \{\
                ...
                submitButton.innerHTML = `\
                    <span style="display: inline-flex; align-items: center; gap: 0.5rem;">\
                        \uc0\u9989  Session Scheduled Successfully!\
                    </span>\
                `;\
                ...
                successMessage.innerHTML = `\
                    <h4 style="margin: 0 0 0.5rem 0; font-size: 1.3rem;">\uc0\u55356 \u57225  Thank You!</h4>\
